...
/** Legacy knowledge-map entry — graph/trail experience demoted but preserved. */
    ...
    <main className="mx-auto flex min-h-screen w-full max-w-2xl flex-col items-center justify-center px-5 py-16">
      <div className="mb-10 text-center">
        ...
        <p className="mx-auto mt-4 max-w-md text-balance text-base leading-relaxed text-ink-muted md:text-lg">
          A navigable map of ideas. Enter any topic in science or history and travel the
          connections — including the ones you didn&rsquo;t know to ask about.
        </p>
      </div>
